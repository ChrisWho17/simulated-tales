...
export const initialLocations: Record<string, Location> = {
  ...
  university_district: {
    ...
    description: 'The academic heart of the city. Gothic buildings mix with modern architecture. Students hurry between classes while professors discuss in hushed tones.',
    connectedLocations: ['campus_quad', 'student_housing', 'university_library', 'town_square'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['campus_protest', 'exam_week', 'career_fair'],
    timeDescriptions: {
      morning: 'Early risers jog past as the first classes begin. Coffee shops buzz with students fueling up.',
      afternoon: 'The campus is alive with activity. Students sprawl on lawns, and the library is packed.',
      evening: 'Study groups form as the sun sets. The library glows with late-night dedication.',
      night: 'Only the most dedicated remain. Security patrols quietly past darkened buildings.',
    },
  },
  campus_quad: {
    id: 'campus_quad',
    name: 'Campus Quad',
    description: 'A large grassy area surrounded by academic buildings. Benches line the pathways and a weathered statue stands in the center.',
    connectedLocations: ['university_district', 'student_housing'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['club_recruitment', 'impromptu_concert', 'political_rally'],
  },
  student_housing: {
    id: 'student_housing',
    name: 'Student Housing - Dorm Room',
    description: 'A small shared dorm room with two beds, desks, and barely enough space to move. Posters cover the walls and textbooks pile on every surface.',
    connectedLocations: ['university_district', 'campus_quad'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['roommate_conflict', 'party_invite', 'quiet_hours_violation'],
  },
  university_library: {
    id: 'university_library',
    name: 'University Library',
    description: 'A vast repository of knowledge. Towering shelves of books stretch toward high ceilings. Study carrels line the walls.',
    connectedLocations: ['university_district'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['research_breakthrough', 'overdue_fines', 'secret_archive_discovery'],
  },
  
  mid_residential: {
    id: 'mid_residential',
    name: 'Mid-Income Residential',
    description: 'A quiet suburban neighborhood with modest homes and well-kept lawns. Neighbors wave from porches and children play in yards.',
    connectedLocations: ['family_home', 'local_park', 'corner_store', 'town_square'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['neighborhood_bbq', 'garage_sale', 'block_party'],
    timeDescriptions: {
      morning: 'The smell of coffee and breakfast drifts from open windows. Cars pull out for the morning commute.',
      afternoon: 'The neighborhood is quiet. Lawn mowers hum and mail carriers make their rounds.',
      evening: 'Families return home. The smell of dinner cooking fills the air as lights flicker on.',
      night: 'The streets are peaceful. Only the occasional dog bark or passing car breaks the silence.',
    },
  },
  family_home: {
    id: 'family_home',
    name: 'Family Home',
    description: 'A comfortable house with lived-in furniture and family photos on every wall. The kitchen always smells of something cooking.',
    connectedLocations: ['mid_residential', 'local_park'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['family_dinner', 'chore_demands', 'sibling_rivalry'],
  },
  local_park: {
    id: 'local_park',
    name: 'Local Park',
    description: 'A small neighborhood park with a playground, benches, and a walking path. Trees provide shade on hot days.',
    connectedLocations: ['mid_residential', 'family_home'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['dog_walking', 'pickup_game', 'suspicious_activity'],
  },
  corner_store: {
    id: 'corner_store',
    name: 'Corner Store',
    description: 'A small convenience store run by a local family. Snacks, basics, and local gossip available 24/7.',
    connectedLocations: ['mid_residential'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['lottery_winner', 'shoplifter_chase', 'late_night_encounter'],
  },
  
  decaying_sector: {
    id: 'decaying_sector',
    name: 'Decaying Sector / Underbridge',
    description: 'The forgotten part of the city. Abandoned buildings and makeshift shelters line the streets. The air smells of smoke and desperation.',
    connectedLocations: ['underbridge', 'soup_kitchen', 'abandoned_warehouse', 'town_square'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['police_sweep', 'resource_share', 'territory_dispute'],
    timeDescriptions: {
      morning: 'Early risers pack up camps before the streets get busy. The soup kitchen line starts forming.',
      afternoon: 'People gather in small groups, sharing what little they have. Some pan for change.',
      evening: 'Fires flicker in barrels as people settle in for the night. The vulnerable seek safety in numbers.',
      night: 'Dangerous hours. Those without shelter find hidden spots while predators prowl.',
    },
  },
  underbridge: {
    id: 'underbridge',
    name: 'Underbridge Camp',
    description: 'A makeshift community under a highway overpass. Tarps and cardboard form temporary homes. A sense of wary community prevails.',
    connectedLocations: ['decaying_sector', 'soup_kitchen'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['newcomer_hazing', 'resource_theft', 'community_meeting'],
  },
  soup_kitchen: {
    id: 'soup_kitchen',
    name: 'Hope Street Soup Kitchen',
    description: 'A church-run facility offering hot meals and basic services. Long lines form at meal times.',
    connectedLocations: ['decaying_sector', 'underbridge'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['volunteer_recruitment', 'resource_shortage', 'outreach_worker'],
  },
  abandoned_warehouse: {
    id: 'abandoned_warehouse',
    name: 'Abandoned Warehouse',
    description: 'A crumbling industrial building. Squatters have carved out living spaces among the debris. Watch for weak floors.',
    connectedLocations: ['decaying_sector'],
    npcsPresent: [],
    items: [],
    possibleEvents: ['squatter_eviction', 'hidden_stash', 'structure_collapse'],
  },
};
