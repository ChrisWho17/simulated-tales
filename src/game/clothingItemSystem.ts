...
export const CLOTHING_DATABASE: ClothingItem[] = [
  ...
  },
  {
    ...
    description: 'Reinforced ballistic helmet with full face guard. Severely limits peripheral vision.',
    slot: 'head',
    style: 'military',
    rarity: 'epic',
  ...
  },
  {
    ...
    description: 'Military-grade ballistic armor with ceramic plates. Bulky and loud.',
    slot: 'torso',
    style: 'military',
    rarity: 'epic',
  ...
  },
  {
    ...
    description: 'Full tactical armor designed for crowd control. Very noisy when moving.',
    slot: 'torso',
    style: 'military',
    rarity: 'legendary',
  ...
  },
  {
    ...
    description: 'Reinforced tactical boots with ankle protection. Makes loud stomping sounds.',
    slot: 'feet',
    style: 'military',
    rarity: 'rare',
