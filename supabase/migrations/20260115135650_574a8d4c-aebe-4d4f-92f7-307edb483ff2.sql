-- Create lifetime_stats table for cloud sync of lifetime statistics
...
CREATE POLICY "Users can create their own lifetime stats" 
ON public.lifetime_stats 
FOR INSERT 
...
CREATE POLICY "Users can delete their own lifetime stats" 
ON public.lifetime_stats 
FOR DELETE 
USING (auth.uid() = user_id);
