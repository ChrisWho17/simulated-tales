...
const GENRE_STYLES: Record<string, { style: string; backgrounds: string[] }> = {
  modern: {
    ...
    backgrounds: [
      'dramatic warzone with explosions and smoke in background',
      'destroyed urban battlefield with burning buildings',
      'military forward operating base at golden hour',
      'intense combat zone with debris and fire',
      'smoky battlefield with distant explosions',
    ],
  },
  war: {
    ...
    backgrounds: [
      'epic warzone battlefield with explosions and black smoke',
      'burning urban combat zone with destroyed vehicles',
      'intense firefight scene with tracer rounds',
      'military base under attack with dramatic lighting',
      'trench warfare with artillery explosions',
    ],
  },
  cyberpunk: {
    ...
    backgrounds: [
      'neon-lit cyberpunk megacity at night with rain and holograms',
      'dark cyberpunk alleyway with neon signs and steam',
      'high-tech corporate facility with holographic displays',
      'dystopian cityscape with massive neon advertisements',
    ],
  },
  postapoc: {
    ...
    backgrounds: [
      'desolate wasteland with ruined city skyline',
      'overgrown abandoned city with nature reclaiming buildings',
      'dusty desert wasteland with wrecked vehicles',
      'radioactive ruins with ominous sky',
    ],
  },
  scifi: {
    ...
    backgrounds: [
      'massive spaceship bridge with holographic displays',
      'alien planet surface with strange atmosphere',
      'futuristic space station interior',
      'epic space battle visible through viewport',
    ],
  },
  ww2: {
    ...
    backgrounds: [
      'World War 2 European battlefield with trenches',
      'bombed French village with rubble',
      'D-Day beach with obstacles',
      'underground bunker with maps and radio equipment',
    ],
  },
  medieval: {
    ...
    backgrounds: [
      'epic medieval castle siege with catapults',
      'dark enchanted forest with mystical fog',
      'bloody medieval battlefield with fallen warriors',
      'grand castle throne room with banners',
    ],
  },
  fantasy: {
    ...
    backgrounds: [
      'ancient magical forest with glowing particles',
      'epic fantasy castle with dramatic sky',
      'mystical realm with floating islands',
  ...
  horror: {
    ...
    backgrounds: [
      ...
      'fog-shrouded graveyard at night',
      'decrepit haunted mansion interior',
      'dark forest with ominous shadows',
    ],
  },
  western: {
    ...
    backgrounds: [
      ...
      'dramatic desert canyon at sunset',
      'old western saloon interior',
      'vast prairie with storm approaching',
    ],
  },
  noir: {
    style: 'classic film noir attire, 1940s fedora and trench coat, dramatic shadows on face, vintage firearms, cigarette smoke',
    backgrounds: [
      'rainy noir city street with neon signs',
      'smoky detective office with venetian blinds',
      'dimly lit jazz bar',
      'dark alleyway with single streetlight',
    ],
  },
  mystery: {
  ...
  pirate: {
    ...
    backgrounds: [
      'ship deck during dramatic storm',
      'tropical island cove at sunset',
      'port tavern with candlelight',
      'treasure cave with gold',
    ],
  },
};
